...
public class PullToRefreshWebView extends PullToRefreshBase<ScrollWebView> {
	...
	private static final OnRefreshListener<ScrollWebView> defaultOnRefreshListener = new OnRefreshListener<ScrollWebView>() {

		@Override
		public void onRefresh(PullToRefreshBase<ScrollWebView> refreshView) {
...
//
//		@Override
//		public void onProgressChanged(ScrollWebView view, int newProgress) {
//			if (newProgress == 100) {
//				onRefreshComplete();
//			}
//		}
...
//		mRefreshableView.setWebChromeClient(defaultWebChromeClient);
	...
	@Override
	protected ScrollWebView createRefreshableView(Context context, AttributeSet attrs) {
		ScrollWebView webView;
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			webView = new InternalWebViewSDK9(context, attrs);
		} else {
			webView = new ScrollWebView(context, attrs);
		}
	...
	@TargetApi(9)
	final class InternalWebViewSDK9 extends ScrollWebView {
